...
const DB_SYNC = (() => {
    ...
    const api = {
        ...
        saveBaby: (data) => saveToCollection(collectionMap.baby, data),
        saveToddler: (data) => saveToCollection(collectionMap.toddler, data),
        ...
        saveFertility: (data) => saveToCollection(collectionMap.fertility, data),

        loadPregnancy: (userId = getUserId()) => loadFromCollection(collectionMap.pregnancy, userId),
        loadBaby: (userId = getUserId()) => loadFromCollection(collectionMap.baby, userId),
        loadToddler: (userId = getUserId()) => loadFromCollection(collectionMap.toddler, userId),
        ...
        loadFertility: (userId = getUserId()) => loadFromCollection(collectionMap.fertility, userId)
    };
