// MongoDB Atlas Service for Mamasafe Application
class MongoDBService {
    ...
    // Specific methods for Mamasafe data
    ...
    async saveBabyData(data) {
        return this.save('babyData', data);
    }

    // Save toddler data
    async saveToddlerData(data) {
        return this.save('toddlerData', data);
    }
    ...
    // Get baby data for user
    async getBabyData(userId) {
        return this.get('babyData', { userId });
    }

    // Get toddler data for user
    async getToddlerData(userId) {
        return this.get('toddlerData', { userId });
    }
