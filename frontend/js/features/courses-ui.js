...
class CoursesAdvancedUI {
    ...
    async handleChatSubmit(courseId, topicId) {
        ...
        loadingMsg.innerHTML = '<span class="course-loader" style="width: 15px; height: 15px; border-width: 2px; display: inline-block;"></span> Syncing with Groq...';
     ...
     getResourceGuide(key) {
         const guides = {
             ...
             articles: {
                 ...
                 defaultQuestion: 'Build a weekly learning playlist with articles and videos for pregnancy, newborn care, sleep, feeding, and recovery.',
                 ...
                 sections: [
                     {
                         ...
                         items: ['Pregnancy week by week', 'Breastfeeding and newborn care', 'Postpartum recovery and support']
                     },
                     {
                 ...
                 quickActions: ['Build my playlist', 'Summarize newborn basics', 'Create a postpartum learning plan']
             }
         };
                 ...
                 <div class="resource-guide-hero">
                     ...
                     <label>
                         ...
                         <select id="resourceStage-${key}">
                             ...
                             <option value="baby" ${selectedStage === 'baby' ? 'selected' : ''}>Baby care</option>
                         </select>
                     </label>
                 </div>
...
window.askResourceGuideAI = async function(key) {
    ...
    answerEl.innerHTML = '<div class="course-loader" style="width: 24px; height: 24px; border-width: 2px;"></div><span>Building your guide with Groq AI...</span>';
