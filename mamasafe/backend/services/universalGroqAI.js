...
function buildUniversalPrompt(functionName, context, inputData, userContext) {
    ...
    prompt += `Please provide a comprehensive and helpful answer for this ${functionName} function. Consider the user's specific context and provide personalized recommendations.\n\n`;
    prompt += 'Response:';
